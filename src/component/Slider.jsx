  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col gap-2 justify-center p-4 items-center absolute inset-0"  >
        ...
        <button className="relative text-white border  border-white p-2 mt-5  border-dashed font-bold transition hover:ease-in hover:bg-pink-600 overflow-hidden inline-block">
  <a href="mailto:realbitebuzz@gmail.com" className="relative z-10">Get started now</a>
  <div className="absolute top-0 right-0 h-full w-full  transition-all ease-linear"></div>
</button>
